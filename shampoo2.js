...
usage_span2.onclick = () => {
    ...
    p1.innerText="Wet hair thoroughly with lukewarm water. Apply a generous amount of this onion shampoo onto wet hair and scalp. Massage well and rinse thoroughly. Follow with our nourishing Onion & Moringa conditioner. Use daily for best results."
...
usage_span4.onclick = () => {
    ...
    li1.innerText="Onion Seed Oil: This hair shampoo is infused with pure, cold-pressed onion seed oil - a superfood ingredient known for calming and soothing hair, and promoting hair growth while controlling hair fall."
    li2.innerText="Moringa Oil: Strengthens hair without drying it out, and promotes scalp health. It also strengthens your hair follicles from root to tip"
    li3.innerText="Shikakai: Shikakai or soap nut powder, present in onion hair shampoo has a soothing effect on the scalp and also cleanses it while removing any buildup or dirt."
...
usage_span5.onclick = () => {
    ...
    p2.innerText="A: MyGlamm SUPERFOODS Onion & Moringa Hair Shampoo is enriched with pure, cold-pressed onion seed oil that controls hair fall, promotes hair growth and supports thick, long hair. It’s also infused with Moringa, rich in minerals and vitamins which not only nourish hair but also strengthens and smoothes hair without drying it out. It also helps fight frizz, dryness, and strengthens your hair follicles from root to tip. This innovative formula is also rich in Shikakai that soothes the scalp, nourishes your hair follicles, reduces buildup and also gets rid of dandruff. It also works on your hair to prevent premature greying."

    p3.innerText="Q: Does this shampoo reduce hair fall?";
    p4.innerText="A: MyGlamm SUPERFOODS Onion & Moringa Hair Shampoo is enriched with pure, cold pressed onion seed oil to control hair fall, promote hair growth and support thick, long hair. It’s also infused with the superfood - moringa. It is rich in minerals and vitamins which not only nourish hair but also deliver long-lasting hydration. This innovative formula also fights dandruff and soothes the scalp."


    p5.innerText="Q: Is this shampoo gentle to use?";
    p6.innerText="A: Yes, MyGlamm SUPERFOODS Onion & Moringa Hair Shampoo is gentle to use. It’s a paraben-free, mineral oil-free and silicone-free formula created with natural ingredients and contains no harmful chemicals. It gently cleanses your hair without stripping the scalp's natural oils, leaving it super smooth and shiny.";
...
function show_what_it_is_page(){
    ...
    let ul=document.createElement("ul");
    let li1=document.createElement("li");
    li1.innerText="An effective hair growth Shampoo powered with a high concentration of cold-pressed Onion Seed Oil, Moringa Oil & Shikakai"
    let li2=document.createElement("li");
    li2.innerText="An anti-hair loss shampoo that nourishes roots and helps control hair fall"
    let li3=document.createElement("li");
