...
document
  .getElementById("div2")
  .append(Name, description, icondiv, price, mrp, div4);
...
usage_span3.onclick = () => {
  ...
  li_1.innerText =
    "For a bold and beautiful monochromatic look, apply the creamy matte lipstick to your eyes, lips and cheeks.";
  li_2.innerText =
    "Don't forget to exfoliate and mositurise your lips before applying lipstick.";
...
usage_span4.onclick = () => {
  ...
  p.innerText =
    "Ethylhexyl Palmitate, Octyldodecyl Stearoyl Stearate, Polyethylene, Pentaerythrityl Tetraisostearate, C18-36 Acid Glycol Ester, Silica, Bis-diglyceryl Polyacyladipate-2, Octyldodecanol, Caprylic/Capric Triglyceride, Synthetic Beeswax, Dimethiconol Behenate, Ozokerite, Aroma, Diethylhexyl Syringylidenemalonate, Aluminum Hydroxide, [+/-] CI 77891, CI 77491, CI 77492, CI77499, CI 77163, CI 15850, CI 45410, CI 19140, CI 42090";
...
usage_span5.onclick = () => {
  ...
  p2.innerText =
    "A: A creamy matte lipstick has a soft creamy texture with a demi matte finish. The LIT Creamy Matte Lipsticks by MyGlamm delivers both a matte finish without drying out your lips.";

  p3.innerText =
    "Q: Do I need to apply a lip balm before I apply this creamy matte lipstick?";
  p4.innerText =
    "A: If you want added moisture, you can apply a lip balm. But remember to always exfoliate before applying any matte lipstick.";

  p5.innerText = "Q: What is the shelf-life of the product?";
  p6.innerText =
    "A: All products that will be shipped will have a shelf-life of minimum 8 months to 12 months.";
...
function show_what_it_is_page() {
  ...
  let p1 = document.createElement("p");
  p1.innerText =
    "Flirtini is a classic deep red shade that’s perfect for a hot date. It is also PETA Approved cruelty-free and vegan..";
  let p2 = document.createElement("p");
  p2.innerText =
